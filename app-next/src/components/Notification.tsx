...
const NotificationList = () => {
  ...
  return (
    <div
      className={`z-20 fixed inset-0 flex items-end px-4 py-6 pointer-events-none sm:p-6 mb-12 sm:mb-1 `}
    >
...
const Notification = ({ type, message, description, txid, onHide }) => {
  ...
  return (
    <div
      className={`max-w-sm w-full bg-bkg-1 shadow-lg rounded-md mt-2 pointer-events-auto ring-1 ring-black ring-opacity-5 mb-1 overflow-hidden ${bgColor}`}
    >
      <div className={`p-2`}>
